...
function About() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="pt-20 bg-white px-12 flex items-end justify-between w-full"
    >
      {/* Text Section */}
      <motion.div
        ...
        transition={{ duration: 1, ease: 'easeInOut' }}
        viewport={{ once: true }}
        className="w-2/3 h-full flex flex-col gap-8"
      >
        <div className="text-gray-500 text-md">ABOUT ME</div>
        <div className="text-[3rem] font-[500] leading-[3rem]">
