  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pb-10 flex w-full justify-between items-center"
      >
      ...
      <motion.div
        variants={containerVariants}
        className="flex w-full items-center border-b-2 border-gray-300 py-4 justify-between"
      >
        ...
        <motion.div variants={itemVariants} className="w-[30rem]">
